...
class CreateAndCommitFiles implements FileState
{
    use StateHelper;
    ...
    public function editTwoFiles(): void
    {
        $this->gitCommand->getFileManager()->editFile($this->files[1]);
        $this->gitCommand->getFileManager()->editFile($this->files[2]);
    }
}
